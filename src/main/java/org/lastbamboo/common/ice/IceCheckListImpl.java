...
public class IceCheckListImpl implements IceCheckList {
    ...
    public void formCheckList(final Collection<IceCandidate> remoteCandidates) {
            ...
            for (final IceCandidate remoteCandidate : remoteCandidates) {
                ...
                if (shouldPair(localCandidate, remoteCandidate)) {
                    final Pair<IceCandidate, IceCandidate> pair = 
                        new PairImpl<IceCandidate, IceCandidate>(
        ...
        final List<Pair<IceCandidate, IceCandidate>> convertedPairs = convertPairs(pairs);
        ...
        final Comparator<Pair<IceCandidate, IceCandidate>> comparator = 
            ...
            public int compare(final Pair<IceCandidate, IceCandidate> pair1,
        ...
        /*
         * final Closure<IceCandidatePair> tcpTurnClosure = new
         * Closure<IceCandidatePair>() { private final Set<InetAddress>
         * addedAddresses = new HashSet<InetAddress>(); public void
    ...
    private List<IceCandidatePair> sortPairs(final List<IceCandidatePair> pairs) {
        synchronized (this) {
    ...
    public boolean hasHigherPriorityPendingPair(final IceCandidatePair pair) {
        ...
        final Predicate<IceCandidatePair> triggeredPred = new Predicate<IceCandidatePair>() {
    ...
    public void removeWaitingAndFrozenPairs(final IceCandidatePair nominatedPair) {
        ...
        synchronized (this) {
            for (final Iterator<IceCandidatePair> iter = m_pairs.iterator(); iter
                    .hasNext();) {
            ...
            for (final Iterator<IceCandidatePair> iter = m_triggeredQueue
